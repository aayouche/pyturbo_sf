...
# For structured 3D grid, include full coordinate arrays
ds_3d_structured = xr.Dataset(
    data_vars={
        "u": (["z", "y", "x"], u),
        "v": (["z", "y", "x"], v),
        "w": (["z", "y", "x"], w),
...
- Time series
- Any structured (uniform or non-uniform grid) 1D, 2D, or 3D data in cartesian Grid
...
<p align="center">
<img src="docs/source/benchmark/benchmark.png" alt="PyTurbo Performance Benchmarks" width="600"/>
</p>
